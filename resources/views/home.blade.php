...
<div class="container">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="profile__avatar">
              <img src="https://www.logolynx.com/images/logolynx/03/039b004617d1ef43cf1769aae45d6ea2.png" alt="...">
            </div>
            <div class="profile__header">
              <h4>Ejemplo  <small></small></h4>
              <p class="text-muted">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <table class="table profile__table">
              <tbody>
                <tr>
                  <th><strong>Habilidad 1</strong></th>
                  <td>Programador</td>
                </tr>
                <tr>
                  <th><strong>Habilidad 2</strong></th>
                  <td>Dise̱ador</td>
                </tr>
                <tr>
                  <th><strong>Habilidad 3</strong></th>
                  <td>Administrador</td>
                </tr>
              </tbody>
            </table>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
          <h4 class="panel-title">Historial de Proyectos</h4>
          </div>
          <div class="panel-body">
